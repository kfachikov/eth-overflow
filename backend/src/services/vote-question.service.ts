...
import {QuestionVoteDto} from "../model/question.model";

@Service()
export class VoteQuestionService {
    async voteQuestion(userId: number, questionId: number, questionVoteDto: QuestionVoteDto) {
        ...
        const finalScore = questionVoteDto.score
